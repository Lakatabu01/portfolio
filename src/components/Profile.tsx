      ...
      <div className="about">
        <div className="all-profile-text">
          ...
          <p className="profile-text">
            ...
            <span className="white">user</span> needs. I'm always eager to
            tackle what I don't know, <span className="white">learning</span>{" "}
          ...
          <p className="profile-text">
            ...
            other passions, listening to <span className="white">
              music
            </span>{" "}
            that fuels my inspiration and hitting the{" "}
